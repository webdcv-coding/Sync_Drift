...
/** @type {string} */
const CACHE_VERSION = '1777318084|11949580154';
/** @type {string} */
const CACHE_PREFIX = 'Sync-Drift-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Sync-Drift.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Sync-Drift.html","Sync-Drift.js","Sync-Drift.offline.html","Sync-Drift.icon.png","Sync-Drift.apple-touch-icon.png","Sync-Drift.audio.worklet.js","Sync-Drift.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Sync-Drift.wasm","Sync-Drift.pck"];
